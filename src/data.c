...
book *newBook(int amount, int borrowed, char isbn[10], char *title, char *author, char **borrower)
{
...
int addBook(int amount, int borrowed, char isbn[10], char *title, char *author, char **borrower)
{
  lib.count += 1;
